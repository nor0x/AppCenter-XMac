...
namespace Microsoft.AppCenter.Distribute.iOS.Bindings
{
    ...
    {
        // @optional - (BOOL)distribute:(MSACDistribute *)distribute releaseAvailableWithDetails:(MSReleaseDetails *)details;
        [Export("distribute:releaseAvailableWithDetails:")]
        bool OnReleaseAvailable(MSACDistribute distribute, MSReleaseDetails details);
    }
